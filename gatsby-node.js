...
module.exports.createPages = async ({ graphql, actions }) => {
  ...
  helsinkiFirstBatch.forEach((edge, index) => {
    createPage({
      ...
      context: {
        ...
        next:
          index === helsinkiFirstBatch.length - 1
            ? null
            : helsinkiFirstBatch[index + 1].node,
      },
    })
  })
  ...
  const helsinkiSecondBatch =
    resHelsinkiSecondBatch.data.allContentfulHelsinkiSecondBatch.edges
  helsinkiSecondBatch.forEach((edge, index) => {
    createPage({
      ...
      context: {
        ...
        next:
          index === helsinkiSecondBatch.length - 1
            ? null
            : helsinkiSecondBatch[index + 1].node,
      },
    })
  })
  ...
  const theLordAndNewCreatures =
    resTheLordAndTheNewCreatures.data.allContentfulTheLordAndTheNewCreatures
      .edges
  theLordAndNewCreatures.forEach((edge, index) => {
    createPage({
      ...
      context: {
        ...
        next:
          index === theLordAndNewCreatures.length - 1
            ? null
            : theLordAndNewCreatures[index + 1].node,
      },
    })
  })
  ...
  allegories.forEach((edge, index) => {
    createPage({
      ...
      context: {
        ...
        next:
          index === allegories.length - 1 ? null : allegories[index + 1].node,
      },
    })
  })
  ...
  lightsSydney.forEach((edge, index) => {
    createPage({
      ...
      context: {
        ...
        next:
          index === lightsSydney.length - 1
            ? null
            : lightsSydney[index + 1].node,
      },
    })
  })
  ...
  `)
  const whileTraveling =
    resWhileTraveling.data.allContentfulWhileTraveling.edges
  whileTraveling.forEach((edge, index) => {
    createPage({
      ...
      context: {
        ...
        next:
          index === whileTraveling.length - 1
            ? null
            : whileTraveling[index + 1].node,
      },
    })
  })
