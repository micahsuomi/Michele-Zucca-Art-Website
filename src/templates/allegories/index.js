    ...
    return (
        <div>
          ...
          <div className={portfolioStyles.exitContainer}>
            ...
            <img src={props.data.contentfulAllegories.image.file.url} alt={props.data.contentfulAllegories.image.description} className={styles.imagePhoto}/>
            <div>
              {nextAllegories && (
            ...
            {documentToReactComponents(props.data.contentfulAllegories.body.json, options)}
